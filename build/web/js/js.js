...
window.onload = function arrancarJuego() {
    ...
    document.getElementById("dificultad").onclick = function () {
        ...
        if (dificultad > 3)
            dificultad = 1;
        crearNave(modeloNave, dificultad, modeloLuna);
    };
...
//crear la nave tipo "objeto" pasandole los parametros de su modelo, dificultad y tipo de luna
function crearNave(m, d, l) {
...
function cargarConfiguracion() {
    var url = "CargarConf";
    var emess = "Error desconocido, contactar con el administrador de la aplicación.";
